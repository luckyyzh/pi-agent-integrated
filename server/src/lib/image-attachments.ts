/// <reference lib="dom" />
// compressImageFile below is browser-only (canvas/ImageBitmap) and never runs
// here; the dom reference lets this file stay a verbatim copy of the pi-web
// module without adding "dom" to the whole server program.
